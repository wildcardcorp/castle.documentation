...
Castle is a content management system (CMS) which you can use to build a
web site. With Castle, ordinary people can contribute content to a web
site without the help of a computer geek. Castle runs over the Web too,
...
.. figure:: /_static/content_types_into_Castle.png
   :align: center
   :alt:

A Castle web site contains various kinds of content, including text,
...
your local computer. You create *folders* on a Castle web site to hold
...
You may wonder how it all works. A typical Castle web site exists as an
installation of Castle software on a web server. The web server may be
...
computers to the Internet, across fast network connections. Your Castle
...
channels of the Internet to interact with your Castle software
installation on the server.

Let's simplify the diagram showing how you interact with Castle:
...
to view and edit your Castle web site, and the changes are stored by the
Castle software into its database storage system.

For example, imagine your butterfly Castle web site is located at
...
The Castle software responds:

.. figure:: /_static/server_response.png
   :align: center
   :alt:

Castle reads its database to look for information stored in mysite.com.
...
you HTML details, but one of Castle's advantages is that you don't
need to know about HTML. That's one reason for Castle and other
...
.. figure:: /_static/Castle_donut.png
   :align: center
   :alt:
...
.. figure:: /_static/Castle_donut_full.png
   :align: center
   :alt:
